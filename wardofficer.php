                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8" data-filter=#filter>
                                ...
                                <tr>
                                    ...
                                    <?php if ($result1['oapproval']==0) {
                                    echo '<th data-hide="all">Action</th>';
                                  }
                                    ?>
                                 ...
                                 <?php
                                        ...
                                        <tr class="tablerow<?php echo $result1['id'];?>">
                                         ...
                                         <td><?php if ($result1['status']==0) { 
                                            echo '<a href="wardofficer.php?id='.$result1['id'].'&act=ongoing"><span class="label label-danger">Ongoing</span></a>';
                                         }
                                         else {
                                            echo '<a href="wardofficer.php?id='.$result1['id'].'&act=completed">  <span class="label label-primary">Completed</span></a>';
                                        }
                                        ?></td>      
                                              
                                             
                                             <?php if ($result1['oapproval']==0) {  echo '<td><a href="wardofficer.php?id='.$result1['id'].'&act=oapproval"> <button type="button" class="btn btn-outline btn-warning">Official Approval</button></a></td>';
                                         }   
                                             ?>  
