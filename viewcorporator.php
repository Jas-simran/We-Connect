...
//echo $email;
$query="SELECT * FROM userdetails where role='corporator'";
                                ...
                                <tbody>
                                 <?php
                                        ...
                                        <tr class="tablerow<?php echo $result1['id'];?>">
                                         ...
                                         <td><?php echo '<a href="addcorporator.php?id='.$result1['id'].'"><button class="btn btn-outline btn-success" type="button">Change</button></a>';?>
                                            <?php echo '<a class="delete" id='.$result1['id'].'><button class="btn btn-outline btn-danger" type="button">Delete</button></a>';?>
                                        </td>
