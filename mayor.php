...
//echo $cdate;
$query="SELECT * FROM complaint where doc <= '$cdate'";
                                ...
                                <tbody>
                                 <?php
                                        ...
                                        ?></td>      
                                             ...
                                             <?php if ($result1['oapproval']==0) {  echo '<td><a href="viewcomplaint.php?id='.$result1['id'].'&act=oapproval"> <button type="button" class="btn btn-outline btn-warning">Official Approval</button></a></td>';
                                         }   
                                             ?>  
